...
##plotting the extracted film tip velocity vs time

plt.plot(df1["t"], df1["vTip"], 'c--', linewidth = "1.5")
plt.plot(df1["t"], df1["vTip"], 'co', mec = 'black',  markersize=8, markeredgewidth = 1, label=r'$v$: y component')
plt.plot(df1["t"], -df1["uTip"], 'g--', linewidth = "1.5")
plt.plot(df1["t"], -df1["uTip"], 'go',mec = 'black',  markersize=8, markeredgewidth = 1, label=r'$|u|$: x component')
plt.plot(df1["t"], df1["velTip"], 'r--', linewidth = "1.5")
plt.plot(df1["t"], df1["velTip"], 'ro', mec = 'black',  markersize=8, markeredgewidth = 1, label=r'$|V_{tip}| = \sqrt{(u^2 + v^2)}$')
plt.xlabel(r"$t/\tau_{\gamma}$")
plt.ylabel(r'$V/V_{\gamma}$')
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), frameon=True)
plt.savefig('velocities.pdf', bbox_inches='tight')
#plt.show()
plt.clf()

##get tip velocities: numerically differentiating (check);
df1["u1"] = 0.0
df1["v1"] = 0.0
df1["u2"] = 0.0
df1["v2"] = 0.0
...
plt.plot(df2["t"], df2["u_tip"], 'ro',mec = 'black',  markersize=8, markeredgewidth = 1, label="film tip calculated")
plt.plot(df2["t"], df2["uTip"], 'k--', linewidth = "1.5")
plt.plot(df2["t"], df2["uTip"], 'ko',mec = 'black',  markersize=8, markeredgewidth = 1, label="tip velocity")
plt.xlabel(r"$t/\tau_{\gamma}$")
plt.ylabel(r'$u$')
...
plt.plot(df2["t"], df2["v_tip"], 'ro',mec = 'black',  markersize=8, markeredgewidth = 1, label="film tip calculated")
plt.plot(df2["t"], df2["vTip"], 'k--', linewidth = "1.5")
plt.plot(df2["t"], df2["vTip"], 'ko',mec = 'black',  markersize=8, markeredgewidth = 1, label="tip velocity")
plt.xlabel(r"$t/\tau_{\gamma}$")
plt.ylabel(r'$v$')
...
plt.plot(df2["t"], df2["vTip_mag"], 'ro', mec = 'black',  markersize=8, markeredgewidth = 1,label="film tip calculated")
plt.plot(df2["t"], df2["velTip"], 'k--', linewidth = "1.5")
plt.plot(df2["t"], df2["velTip"], 'ko',mec = 'black',  markersize=8, markeredgewidth = 1, label="tip velocity")
plt.xlabel(r"$t/\tau_{\gamma}$")
plt.ylabel(r'$|v|$')
