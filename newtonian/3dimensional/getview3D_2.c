...
view (quat = {-0.471, -0.084, -0.669, 0.569},
      fov = 30, near = 0.01, far = 1000,
      tx = -0.208, ty = -0.403, tz = -4.154,
      width = 1228, height = 754, bg = {0.635, 0.855, 1});
 ...
 // Mirror in positive y direction
  ...
  end_mirror();
  //annotate time
  draw_string ("t =", pos = 1, size = 20, lc = {255, 255, 255}, lw = 7);
  char tp[25] = "    ";
  strcat(tp, tstep);
  draw_string (tp, pos = 1, size = 20, lc = {255, 255, 255}, lw = 7);
